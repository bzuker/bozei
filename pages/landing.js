...
function Landing() {
  return (
    <div className="antialiased overflow-x-hidden">
      <Header />
      {/* BEGIN HERO SECTION */}
      <div className="w-full justify-center items-center relative  overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div className="container max-w-6xl mx-auto h-full flex flex-col lg:flex-row justify-between items-center -mt-32 px-8 xl:px-0">
          <div className="flex flex-col items-center lg:items-start w-full max-w-xl lg:w-1/2 pt-48 lg:pt-20 xl:pt-40 text-center lg:text-left z-30">
            <h1 className="text-gray-900 font-black text-3xl sm:text-6xl leading-tight relative mb-4 xl:mb-8">
            ...
            <a
              href="#_"
              className="mt-0 sm:mt-1 px-8 py-4 rounded-md fold-bold text-base bg-indigo-600 shadow-xl text-white border-t border-gray-200 w-auto font-bold relative self-start inline-block lg:mx-0 mx-auto"
            >
              Signup Today!
            </a>
      ...
      <div
        id="features"
        className="w-full relative py-10 md:py-16 lg:py-24 xl:py-40 border-t border-gray-200 px-8 xl:px-0"
      >
        <div className="container max-w-6xl mx-auto h-full flex flex-col justify-between items-center">
          ...
          <div className="flex flex-col lg:flex-row w-full mt-0 sm:mt-10 lg:mt-20">
            ...
            <div className="w-full max-w-md mx-auto mb-16 lg:mb-0 lg:w-1/3 p-4">
              <div className="flex flex-col justify-center items-center w-full h-full mr-5 p-20 rounded-lg relative">
                <svg
                  className="w-full h-full absolute fill-current text-gray-100"
                  viewBox="0 0 378 410"
      ...
      <div className="bg-white relative py-10 md:py-16 lg:py-24 xl:py-40 border-t border-gray-200 px-8 xl:px-0">
        ...
        >
          ...
          <h3 className="font-black text-2xl mt-2 sm:mt-0 px-5 sm:px-0 sm:text-6xl max-w-2xl leading-tight text-gray-900 text-center w-full px-8 md:px-0">
            Simple, Transparent Pricing for Everyone
          </h3>
          <div className="max-w-full md:max-w-6xl mx-auto sm:px-8">
            {/* Basic Pricing */}
            <div className="relative block flex flex-col sm:flex-row items-center">
              <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg md:-mr-4 border border-gray-200">
                <div className="bg-white text-black rounded-lg border-t border-gray-100 shadow-sm overflow-hidden">
                  <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-5 text-black px-8 lg:px-6">
                    <h3 className="text-lg font-bold uppercase p-3 text-center tracking-wide">
                  ...
                  <div className="block flex items-center p-8  uppercase">
                    <a
                      href="#_"
                      className="mt-3 text-lg font-semibold bg-gray-900 w-full text-white rounded px-6 py-4 block shadow-sm hover:bg-green-600 text-center"
                    >
                      Select This Plan
                    </a>
                  </div>
              ...
              <div className="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg">
                <div className="text-sm leading-none rounded-t bg-indigo-500 text-white font-semibold uppercase py-4 text-center tracking-wide">
                  Most Popular
                </div>
                <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-5 text-black px-8 lg:px-6">
                  <h3 className="text-lg font-bold uppercase p-3 pb-1 text-center tracking-wide">
                    Pro<span className="font-light ml-2">Plan</span>
                  </h3>
                ...
                <div className="block flex items-center p-8  uppercase">
                  <a
                    href="#_"
                    className="mt-3 text-lg font-semibold bg-gray-900 w-full text-white rounded px-6 py-4 block shadow-sm hover:bg-indigo-600 text-center"
                  >
                    Select This Plan
                  </a>
                </div>
      ...
      <div
        id="testimonials"
        className="flex items-center justify-center w-full  py-10 md:py-16 lg:py-24 xl:py-40 border-t border-gray-200 px-8 xl:px-0"
      >
        <div className="max-w-6xl mx-auto">
          <div className="flex-col items-center ">
            <div className="w-full flex flex-col justify-center text-center items-center h-full pr-8 max-w-2xl mx-auto">
              <p className="text-indigo-500 uppercase text-base font-medium tracking-tight my-5">
            ...
            <div className="mx-auto flex flex-col xl:flex-row max-w-2xl xl:max-w-full items-center justify-center py-8">
              <div className="w-full xl:w-1/2 xl:pr-8">
                <blockquote className="w-full flex flex-col-reverse md:flex-row text-center md:text-left  items-center justify-between p-6 col-span-1 bg-gray-100 rounded-lg hover:bg-white hover:shadow transition-all duration-200 ease">
                  <div className="flex flex-col pr-8">
                    <div className="pl-12 relative">
                      <svg
                        className="w-10 h-10 fill-current text-indigo-500 absolute left-0"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 100 125"
                      >
                    ...
                    <h3 className="pl-12 text-gray-800 text-base mt-3 leading-5 font-medium truncate">
                      Sandra Walton{" "}
                      <span className="mt-1 text-gray-500 text-sm leading-5 truncate mt-1">
                        - CEO SomeCompany
                      </span>
                    </h3>
                    <p className="mt-1 text-gray-500 text-sm leading-5 truncate mt-1" />
                  </div>
                  <img
      ...
      {/* End Testimonials*/}
      <footer className="bg-white border-t border-gray-200 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden max-w-6xl flex flex-col lg:flex-row justify-between">
          <div className="w-full lg:w-1/4 mr-4 text-left sm:text-center pl-12 sm:pl-0 lg:text-left">
            ...
            <p className="text-gray-500 text-base mr-4 mt-6">
          ...
          <div className="w-full lg:w-3/4 pl-10 block sm:flex text-sm mt-6 lg:mt-0">
            <ul className="text-gray-700 list-none p-0 font-medium flex flex-col text-left w-full">
              <li className="inline-block py-2 px-3 text-gray-800 uppercase font-bold tracking-wide mt-5 md:mt-0">
                Product
              </li>
              <li>
                <a
                  href="#_"
                  className="inline-block py-2 px-3 text-gray-500 hover:text-gray-600 no-underline"
                >
                  Features
                </a>
              </li>
            ...
            <div className="text-gray-700 flex flex-col w-full">
              <div className="inline-block py-2 px-3 text-gray-800 uppercase font-bold mt-5 md:mt-0">
                Follow Us
              </div>
              <div className="flex pl-4 justify-start mt-2">
                <a
                  className="block flex items-center text-gray-400 hover:text-gray-600 mr-6 no-underline"
                  target="_blank"
                ...
                <a
                  className="block flex items-center text-gray-400 hover:text-gray-600 no-underline"
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://devdojo.com"
                >
